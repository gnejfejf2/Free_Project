...
$optionrows = mysqli_fetch_assoc($optionresult);

$todayquery = "select date_format(date,'%Y-%m') m,count(*) from membervisit where date like '$ym' group by m;";
$todayresult = mysqli_query($conn, $todayquery);
$todayrows = mysqli_fetch_assoc($todayresult);
$options = array(
    'title' => $today,
                        ...
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">오늘하루
                                            접속자수
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                                            if ($todayrows['count(*)'] == null) {
                                                echo 0;
                                            } else {
                                                echo $todayrows['count(*)'];
                                            }
                                            ?>명
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">이번달
                                            접속자수
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php if ($optionrows['count(*)'] == null) {
                                                echo 0;
                                            } else {
                                                echo $optionrows['count(*)'];
                                            } ?>
                                            명
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">방문자
                                            목표수 매달(100명)
                                        </div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php if ($optionrows['count(*)'] == null) {
                                                        echo 0;
                                                    } else {
                                                        echo $optionrows['count(*)'];
                                                    } ?>%</div>
                                            ...
                                            <div class="col">
                                                <div class="progress progress-sm mr-2">
                                                    <div class="progress-bar bg-info" role="progressbar"
                                                         style="width:<?php echo $optionrows['count(*)'];?>%  " aria-valuenow="50" aria-valuemin="0"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="card shadow mb-4">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">이번달 로그인 방문자수</h6>
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">팀노바</h6>
                            </div>
                            <div class="card-body">
                                <h4 class="small font-weight-bold">기초 자바 <span class="float-right">100%</span>
                                </h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 100%"
                                         aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">기초 안드로이드 <span class="float-right">100%</span>
                                </h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-warning" role="progressbar" style="width: 100%"
                                         aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">기초 PHP <span
                                            class="float-right">95%</span></h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar" role="progressbar" style="width: 95%" aria-valuenow="95"
                                         aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">응용 1단계 <span class="float-right">시작전</span>
                                </h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: 0%"
                                         aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 class="small font-weight-bold">응용 2단계 <span
                                            class="float-right">시작전</span></h4>
                                <div class="progress">
